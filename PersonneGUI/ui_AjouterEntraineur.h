...
public:
    ...
    void setupUi(QDialog *AjouterEntraineur)
    {
        ...
        label_4->setGeometry(QRect(20, 340, 121, 16));
        ...
        label_5->setGeometry(QRect(20, 400, 121, 16));
        ...
        label_6->setGeometry(QRect(20, 460, 121, 16));
        ...
        ok->setGeometry(QRect(300, 560, 90, 28));
