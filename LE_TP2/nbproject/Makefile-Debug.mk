...
${OBJECTDIR}/Annuaire.o: Annuaire.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Annuaire.o Annuaire.cpp
...
${OBJECTDIR}/Entraineur.o: Entraineur.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Entraineur.o Entraineur.cpp
...
${OBJECTDIR}/Personne.o: Personne.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Personne.o Personne.cpp
...
${TESTDIR}/tests/AnnuaireTesteur.o: tests/AnnuaireTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/AnnuaireTesteur.o tests/AnnuaireTesteur.cpp


${TESTDIR}/tests/EntraineurTesteur.o: tests/EntraineurTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EntraineurTesteur.o tests/EntraineurTesteur.cpp


${TESTDIR}/tests/JoueurTesteur.o: tests/JoueurTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/JoueurTesteur.o tests/JoueurTesteur.cpp


${TESTDIR}/tests/PersonneTesteur.o: tests/PersonneTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PersonneTesteur.o tests/PersonneTesteur.cpp
...
${OBJECTDIR}/Annuaire_nomain.o: ${OBJECTDIR}/Annuaire.o Annuaire.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Annuaire_nomain.o Annuaire.cpp;\
	else  \
...
${OBJECTDIR}/Entraineur_nomain.o: ${OBJECTDIR}/Entraineur.o Entraineur.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Entraineur_nomain.o Entraineur.cpp;\
	else  \
...
${OBJECTDIR}/Joueur_nomain.o: ${OBJECTDIR}/Joueur.o Joueur.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Joueur_nomain.o Joueur.cpp;\
	else  \
...
${OBJECTDIR}/Personne_nomain.o: ${OBJECTDIR}/Personne.o Personne.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Personne_nomain.o Personne.cpp;\
	else  \
...
${OBJECTDIR}/Validation_nomain.o: ${OBJECTDIR}/Validation.o Validation.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Validation_nomain.o Validation.cpp;\
	else  \
